          ...
          <div className="w-full max-w-sm mx-auto my-auto text-left">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="auth-input w-full pl-5 pr-12 py-3.5 border-2 border-gray-100 focus:border-emerald-700 rounded-2xl text-[14px] font-medium outline-none placeholder-gray-300 bg-gray-50/50"
                    required
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword((prev) => !prev)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-emerald-700 focus:outline-none transition-colors p-1"
              ...
              <button
                type="submit"
                disabled={loading}
                className="auth-pill-btn w-full bg-[#1B5E20] hover:bg-emerald-900 text-white font-bold py-4 rounded-2xl shadow-lg shadow-emerald-900/10 text-[15px] disabled:opacity-50 mt-2 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
