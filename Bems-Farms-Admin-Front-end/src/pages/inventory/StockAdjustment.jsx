  ...
  return (
    <div style={{ fontFamily:'var(--body-font)' }}>
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContext:'space-between', justifyContent:'space-between', marginBottom:20, flexWrap:'wrap', gap:12 }}>
        <div>
          <div style={{ fontFamily:'var(--heading-font)', fontWeight:800, fontSize:20, color:'var(--text-primary)' }}>Stock Adjustments</div>
        </div>
          ...
          <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13, fontFamily:'var(--body-font)' }}>
            ...
            <tbody>
              {loading ? (
                ...
                const refNo = m.reference || `ADJ-${yearOf(m.created_at)}-00${m.id}`
