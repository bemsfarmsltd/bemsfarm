...
export default function BatchManagement() {
  ...
  return (
    <div style={{ fontFamily:'var(--body-font)', minHeight:'calc(100vh - 120px)', display:'flex', alignItems:'center', justifyContent:'center', padding:20 }}>
      <div style={{ background:'var(--bg-card)', borderRadius:16, border:'1px solid var(--border)', padding:'48px 32px', maxWidth:480, textAlign:'center', boxShadow:'var(--shadow-card)' }}>
        ...
        <h1 style={{ fontFamily:'var(--heading-font)', fontWeight:800, fontSize:22, color:'var(--text-primary)', margin:'0 0 10px' }}>Batch Management</h1>
        ...
        <p style={{ fontSize:14, color:'var(--text-secondary)', lineHeight:'1.6', margin:'0 0 28px' }}>
          Batch and lot tracking for inventory freshness, manufacture/expiry alerts, and supplier recall tracking is coming soon. We are building this system to keep your shelf life tracking secure and robust.
        </p>
        <button style={btnP} onClick={() => navigate('/dashboard')}>
