            ...
            <div className="card-body p-2.5">
              <div className="row g-1.5">
                {[
                  ...
                  { label: 'Invite Member', icon: 'ri-mail-send-line',         to: '/settings/team',       primary: false, roles: ['superadmin','admin','manager'] },
                  { label: 'Team Directory', icon: 'ri-team-line',             to: '/staff',               primary: false, roles: ['superadmin','admin','manager'] },
