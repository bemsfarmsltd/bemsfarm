...
const STATUS_CFG = {
  ...
  assigned:                     { label: 'Driver Assigned (Awaiting Pickup)', color: '#0891b2', bg: '#cffafe', icon: 'ri-user-location-line'     },
  driver_assigned:              { label: 'Driver Assigned (Awaiting Pickup)', color: '#0891b2', bg: '#cffafe', icon: 'ri-user-location-line'     },
