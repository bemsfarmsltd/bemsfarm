  ...
  return (
    <div style={{ fontFamily:'var(--body-font)' }}>
      <div style={{ marginBottom:20 }}>
        <div style={{ fontFamily:'var(--heading-font)',fontWeight:800,fontSize:20,color:'var(--text-primary)' }}>Finance Report</div>
      ...
      {!data && !loading && (
        <div style={{ background:'var(--bg-card)',borderRadius:12,border:`1px solid ${B}`,padding:60,textAlign:'center',color:S }}>
          <i className="ri-funds-line" style={{ fontSize:54,display:'block',marginBottom:10 }}/>
      ...
      {data && !loading && (
        <>
          ...
          {data.bank_balances?.length > 0 && (
            <div style={{ background:'var(--bg-card)',borderRadius:12,border:`1px solid ${B}`,overflow:'hidden' }}>
              <div style={{ padding:'14px 20px',borderBottom:`1px solid ${B}`,fontFamily:'var(--heading-font)',fontWeight:700,fontSize:14 }}>Bank Balances</div>
              <table style={{ width:'100%',borderCollapse:'collapse' }}>
