  ...
  return (
    <div style={{ display:'grid', gap:16 }}>
      ...
      <div>
        ...
        <div style={{ fontSize:11, color:'var(--text-light)', marginTop:4 }}>0.0 = weak association, 2.0 = very strong</div>
      </div>
      <div>
                ...
                <tr key={a.id} style={{ borderBottom:'1px solid var(--border)', background: i%2===0 ? 'var(--bg-card)' : 'var(--bg-subtle)' }}>
                  ...
                  <td style={{ padding:'12px 16px' }}>
                    <div style={{ display:'flex', alignItems:'center', gap:8 }}>
                      <div style={{ width:56, height:5, background:'var(--border)', borderRadius:999, overflow:'hidden' }}>
